...
long_worksheet = sheet.get_worksheet(4)
inclined_worksheet = sheet.get_worksheet(5)
inclinedshort_worksheet = sheet.get_worksheet(6)
onestack_worksheet = sheet.get_worksheet(7)